...
<div class="checkout-options">
	...
	<div class="checkout-option-inner">
		<?php
	...
	<div class="row">
		...
		<div class="col-xl-5 col-lg-5 col-md-12 checkout_content-right">
            <div class="checkout-col-right">
            	...
            	?>
            	<a class="button-back-cart" href="<?php echo  esc_attr($link_cart);?>"><span class="theme-icon-back"></span><?php echo esc_html__('Back to cart', 'themebase') ?></a>
                <!-- Order -->
                <h4 class="label-item" id="order_review_heading"><?php esc_html_e( 'Order summary', 'themebase' ); ?></h4>
                ...
                <?php
					...
					if ($count > 0) {
						...
						echo esc_html_e( ' Cart', 'themebase' );
